...
$category_name = "Фильмы и сериалы";
...
<main class="main-content">
    <div class="category-page-container">
        <div class="yt-category-header" style="--bg-image: url('/images/movie-banner.jpg');">
            <div class="yt-category-content">
                <img src="/images/movie-icon.png" alt="<?php echo htmlspecialchars($category_name); ?> Icon" class="yt-category-icon">
                <h1 class="yt-category-title"><?php echo htmlspecialchars($category_name); ?></h1>
                <p class="yt-category-description">
                    Трейлеры, обзоры и полные метры в категории "<?php echo htmlspecialchars($category_name); ?>".
                </p>
            </div>
        </div>
