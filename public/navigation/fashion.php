...
// Загружаем видео, если категория найдена
if ($category_id) {
...
// Загружаем данные пользователя (плейлисты, "Смотреть позже") для отображения в UI
if ($user_id) {
...
<main class="main-content">
    <div class="category-page-container">
        <div class="yt-category-header" style="--bg-image: url('/images/fashion-banner.jpg');">
            <div class="yt-category-content">
                <img src="/images/fashion-icon.png" alt="<?= htmlspecialchars($category_name) ?> Icon" class="yt-category-icon">
                <h1 class="yt-category-title"><?= htmlspecialchars($category_name) ?></h1>
                <p class="yt-category-description">
                    Тренды, обзоры и советы по стилю в категории "<?= htmlspecialchars($category_name) ?>".
                </p>
            </div>
        </div>
