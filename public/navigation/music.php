...
<main class="main-content">
    <div class="category-page-container">
        ...
        <div class="yt-category-header" style="--bg-image: url('/images/music-banner.jpg');">
            <div class="yt-category-content">
                <img src="/images/music-icon.png" alt="Music Icon" class="yt-category-icon">
                <h1 class="yt-category-title"><?= htmlspecialchars($category_name) ?></h1>
                <p class="yt-category-description">
                    Лучшие клипы, живые выступления и новые треки. Все главное из мира музыки — здесь.
                </p>
            </div>
        </div>
...
// Подключаем общие модальные окна (сохранение в плейлист, поделиться и т.д.)
