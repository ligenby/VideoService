...
<main class="main-content">
    <div class="category-page-container">
        ...
        <div class="yt-category-header" style="--bg-image: url('/images/sport-banner.jpg');">
            <div class="yt-category-content">
                <img src="/images/sport-icon.png" alt="<?= htmlspecialchars($category_name) ?> Icon" class="yt-category-icon">
                <h1 class="yt-category-title"><?= htmlspecialchars($category_name) ?></h1>
                <p class="yt-category-description">
                    Лучшие моменты матчей, трансляции и интервью в категории "<?= htmlspecialchars($category_name) ?>".
                </p>
            </div>
        </div>
